...
| :--- | :--- | :--- |
| **Arquitetura da Navegação** | Sugestão inicial da estrutura de nós para navegação entre salas em $360^\circ$. | Evitei a sugestão de carregar várias Cenas no Unity para não deixar o jogo pesado no navegador. Optei por usar uma única cena e trocar apenas o RenderSettings.skybox via código. |
